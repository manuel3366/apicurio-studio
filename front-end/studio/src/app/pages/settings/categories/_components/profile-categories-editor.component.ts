...
@Component({
    selector: "profile-categories-editor",
    templateUrl: "profile-categories-editor.component.html",
    styleUrls: ["profile-categories-editor.component.css"],
    encapsulation: ViewEncapsulation.None,
})
export class ProfileCategoriesEditorComponent {
